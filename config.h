...
static char *fonts[]          = { "Noto Sans CJK SC:size=9", "JoyPixels:pixelsize=9:antialias=true:autohint=true" };
...
/* layout(s) */
static float mfact     = 0.57; /* factor of master area size [0.05..0.95] */
...
static Key keys[] = {
	...
	{ MODKEY,			XK_F8,		spawn,		SHCMD("sh $HOME/.scripts/vpn.sh") },
